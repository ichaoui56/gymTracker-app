...
@if (!$categories->isEmpty())
    <button class="cssbuttons-io-button" data-modal-target="crud-modal" data-modal-toggle="crud-modal" type="button"
        style="background-color: #a370f0;">
        Add Class
        <div class="icon">
        ...
        <div class="relative px-4 py-10 bg-gray-200 dark:bg-slate-900 mx-8 md:mx-0 shadow rounded-xl sm:p-10"
            ...
            <div class="max-w-1/2 mx-auto">
                ...
                <div class="text-center">
                    <h2 class="font-semibold text-2xl text-gray-700">Create a Class</h2>
                    <div class="w-full h- bg-gray-300 absolute top-5 left-0 transform -translate-y-1/2"></div>
                </div>
                <form action="/class/add" method="post" enctype="multipart/form-data" class="divide-y divide-gray-200">
                    @csrf
